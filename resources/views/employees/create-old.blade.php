              ...
              <div class="active tab-pane" id="personal">
                  {{ Form::model(request()->old(),array('route' => array('employees.store'),'enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-4">
                              {{Form::select('job_status',[''=>'--Please Select Job status--']+['Permanent'=>'Permanent', 'Temporary'=>'Temporary'],null,array('class' => 'form-control'))}}
                          </div>
                      </div>
                      <div class="form-group">
                          <label for="inputExperience" class="col-sm-2 ">Present Residential Address</label>
                      ...
                      <div class="form-group">
                          <label for="inputName" class="col-sm-2 ">Highest Education</label>
                          <div class="col-sm-4">
                            {{Form::text('highest_education',null,array('class' => 'form-control'))}}
                              {!! $errors->first('highest_education', '<p class="text-danger">:message</p>' ) !!}
                          </div>
                          <label for="inputName" class="col-sm-2 require">Permanent Residential Address</label>
                          <div class="col-xs-4">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-4">
                              {{Form::select('employee_type',[''=>'--Please Select Employee Type--']+['Management'=>'Management', 'Non-Management'=>'Non-Management'],null,array('class' => 'form-control'))}}
                          </div>
                      </div>
                      <div class="form-group">
