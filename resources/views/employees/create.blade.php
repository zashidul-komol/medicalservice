                  ...
                  {{ Form::model(request()->old(),array('route' => array('employees.store'),'enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
                      ...
                      <div class="form-group">
                        <label for="inputName" class="col-sm-2 ">Department</label>
                          <div class="col-xs-4">
                            {{Form::select('dept_id',[''=>'--Please Select Department--']+$departments->toArray(),null,array('class' => 'form-control select2'))}}
                          </div>
                          
                         <label for="inputName" class="col-sm-2 ">Designation</label>
                          <div class="col-xs-4">
                              {{Form::select('desig_id',[''=>'--Please Select Designation--']+$designations->toArray(),null,array('class' => 'form-control select2'))}}
                          </div>
                      </div>
