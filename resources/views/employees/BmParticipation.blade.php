                ...
                <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td>প্রিয় সহকর্মী</br>
                            ...
                            মাননীয় ব্যবস্থাপনা পরিচালক মহোদয়ের বিশেষ আমন্ত্রনে এই বছর আমরা স্ব-পরিবারে কক্সবাজারে বিজনেসমিট করতে যাচ্ছি। 
                        </br></br>
                ...
                <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{Form::select('child_participation',[''=>'--Please Select Yes/No--']+['Yes'=>'Yes', 'No'=>'No'],null,array('class' => 'form-control'))}}</td>
                        <td>{{Form::text('reason',null, array('class' => 'form-control', 'placeholder'=>"Please insert Reason's"))}}</td>
                      </tr>
            ...
            <div class="panel-content">
              <div class="table-responsive">
                <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th width="100%"><input class="checks" type="checkbox" name="football"/>  I acknowledge that I have read and agree to the "Terms & Conditions" as well as follow the provided Instrauctions & Guidelines.</th>
                      </tr>
                      <tr>
                        <th>
                          <button type="submit" id="submit" class="btn btn-primary"> I Agree with The Terms & Conditionds</button>
                        </th>
                        <th><button type="back" id="back" class="btn btn-primary"> Back to Dashboard</button></th>
                      </tr>
                    </thead>
