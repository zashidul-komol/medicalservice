                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                             ...
                             <div class="form-group">
                                {{Form::label('Market Type:',null,array('class' => 'control-label col-sm-3'))}}
                                <div class="col-md-9">
...
<!-- Start Basic Information -->
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('spouse_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    {{Form::text('spouse_name',null,array('class' => 'form-control','maxlength'=>64))}}
                            ...
                            <div class="form-group{{ $errors->has('father_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    {{Form::text('father_name',null,array('class' => 'form-control','maxlength'=>100))}}
                            ...
                            <div class="form-group{{ $errors->has('son') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    {{Form::number('son',null,array('class' => 'form-control','step'=>'1','min'=>'0','oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);','maxlength'=>2))}}
                        ...
                        <div class="col-md-6">
                             <h5 class="mb-lg"><b>&nbsp;</b></h5>
                                <div class="form-group{{ $errors->has('permanent_address') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        {{Form::textarea('permanent_address',null,array('class' => 'form-control max-length', 'rows' => 5, 'cols' => 2,'maxlength'=>255))}}
                                ...
                                <div class="form-group{{ $errors->has('business_startday') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <span class="input-group-addon x-primary"><i class="fa fa-calendar"></i></span>
                                            {{Form::text('business_startday',null,array('class' => 'form-control datepicker'))}}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('marriage_day') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <span class="input-group-addon x-primary"><i class="fa fa-calendar"></i></span>
                                            {{Form::text('marriage_day',null,array('class' => 'form-control datepicker'))}}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group{{ $errors->has('spouse_birthday') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <span class="input-group-addon x-primary"><i class="fa fa-calendar"></i></span>
                                            {{Form::text('spouse_birthday',null,array('class' => 'form-control datepicker'))}}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('daughter') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        {{Form::number('daughter',null,array('class' => 'form-control','step'=>'1','min'=>'0','oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);','maxlength'=>2))}}
                    ...
                    <div class="row mb-md">
                        <div class="col-md-12">
                            <hr>
                             <h5 class="mb-lg"><b>Select Depot</b></h5>
