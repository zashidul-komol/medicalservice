            ...
            <div class="panel-content">
              ...
              <div class="active tab-pane" id="personal">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            {{Form::textarea('hobby',null,array('class' => 'form-control max-length','rows' => 2, 'cols' => 2,'maxlength'=>'150'))}}
        ...
        <div class="panel">
            <div class="panel-content">
              ...
              <div class="active tab-pane" id="personal">
                        ...
                        <div class="form-group">
                          <label for="inputName" class="col-sm-4 ">Number of Brother (Including You)</label>
                            <div class="col-xs-2">
                                <div class="input-group">
                                  @php
                                    $brother = '';
                        ...
                        <div class="form-group">
                          <label for="inputName" class="col-sm-4 ">Number of Sister (Including You)</label>
                            <div class="col-xs-2">
                                <div class="input-group">
                                  @php
                                    $sister = '';
                        ...
                        <div class="form-group">
                            <label for="inputName" class="col-sm-4">Overall Your Serial (Including You)</label>
                                <div class="col-sm-2">
                                    <div class="input-group">
                                      @php
                                        $overall_position = '';
            ...
            <div class="panel-content">
              ...
              <div class="active tab-pane" id="personal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                              {{Form::select('wife_occupation',[''=>'--Please Select Occupation--']+['Service'=>'Service', 'House Wife'=>'House Wife', 'Student'=>'Student', 'Others'=>'Others'],$spouseOccupation,array('class' => 'form-control','onchange'=>'showItemList(this.value)'))}}
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          {!! Form::delete(route('jobExperiances.destroy',array($data->id))) !!}
                        </td>
