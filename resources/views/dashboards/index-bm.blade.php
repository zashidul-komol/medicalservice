...
<div class="content-header">
    <div class="text-center">
        <ul class="breadcrumbs">
            <li><i class="fa fa-home" aria-hidden="true"></i><a href="#"><h4 class="section-subtitle"><b>Bussiness Meet-2023- Survey Form</b></h4></a></li>
        </ul>
    </div>
</div>

@if(!empty($employees[0]->participations->employee_id))
    <div class="col-md-8">
        <div>
            <span style="margin:auto; display:table; border:0px solid;">
                {!! Html::decode(link_to_route('dashboards.bmparticipation','<i aria-hidden="true"><h7><font size="3">Registration for Business Meet - 2023</font></h7></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
            </span> 
        </div>
...
<div class="row animated fadeInRight">
            ...
            <div class="panel-content">
              ...
              <div class="active tab-pane" id="personal">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            {{Form::text('organization',$employees[0]->organization->organization,array('class' => 'form-control', 'readonly' => 'true'))}}
    ...
    <div class="col-md-3">
        ...
        <div class="panel bg-scale-0 b-primary bt-sm mt-xl">
            <div class="panel-content">
                <div class="box box-primary">
                  <div class="box-body box-profile">
                      <img class="profile-user-img img-responsive img-circle" src="{{ asset('storage/images/avatar/Nirvik_dishari.PNG') }}" />
    ...
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Participant Details Information</b></h4>
        <div class="panel">
            <div class="panel-content">
              <div class="table-responsive">
                <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        ...
                        <th width="20%">Update NID</th>
                        <th width="35%">Uploaded NID</th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        <td>
                            <div class="col-xs-4">
                                <div class="input-group">
                                    <input type="file" name="employee_nid" > 
                                </div>
                            </div>
                        </td>
                        <td>@php
                    ...
                    <tbody>
                        ...
                        <td>
                            <div class="col-xs-4">
                                <div class="input-group">
                                    <input type="file" name="spouse_nid" > 
            ...
            <div class="panel-content">
              <div class="table-responsive">
                <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th width="20%">Children's Name</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{Form::text('reason[]',$data->reason, array('class' => 'form-control', 'placeholder'=>"Please insert Reason's"))}}</td>
                        <td>{{Form::text('child_id[]',$data->id, array('class' => 'form-control', 'placeholder'=>"Please insert Reason's"))}}</td>
                      </tr>
