            ...
            <div class="panel-content">
                  <form id="inline-validation" class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <label for="inputName" class="col-md-2 control-label require">Organization Name </label>
                            <div class="col-md-4">
                              {{Form::select('organization_id',[''=>'Please Select Origin']+$organizations->toArray(),null,array('class' => 'form-control select2','data-placeholder'=>'Please Select Organization'))}}
                            </div>
                        </div>
                        <div class="form-group">
