...
<div class="row animated fadeInRight">
    ...
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Brand Add</b></h4>
        <span class="pull-right">
            {!! Html::decode(link_to_route('brands.index','<i class="fa fa-list"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
            <div class="panel-content">
				{{ Form::model(request()->old(),array('route' => array('brands.store'),'enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}

					<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
						{{Form::label('Brand name:',null,array('class' => 'control-label col-sm-2 require'))}}
						<div class="col-md-6">
			                {{Form::text('name',null,array('class' => 'form-control','placeholder'=>'Ex:Super Ariston'))}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {{Form::text('short_code',null,array('class' => 'form-control','placeholder'=>'Ex:SA'))}}
