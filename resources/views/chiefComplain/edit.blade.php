...
@section('title', 'Update Chief Complain')
@section('content')
    ...
    <div class="col-sm-12">
        ...
        <div class="panel">
            <div class="panel-content">
                {{ Form::model($chiefComplain,array('route' => array('chiefComplain.update',$chiefComplain->id),'method' => 'PUT','enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
