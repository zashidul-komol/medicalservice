        ...
        <div class="panel">
			<div class="panel-content">
					...
					<div class="table-responsive">
						<table class="table table-bordered" cellspacing="0" cellpadding="0" align="left" >
						    <tr>
						        ...
						        <td colspan="{{count($uniqueSizeArr)}}"><strong>DF Received - {{$start_date}} to {{$end_date}} </strong></td>
						    ...
						    <tr>
						        <td colspan="{{count($uniqueSizeArr)+1}}"><strong>Received Date:</strong></td>
				...
				<table>
					...
					<tr>
						<td colspan="100"><b>DF Delivery Summery - {{$start_date}} to {{$end_date}}</b></td>
					</tr>
