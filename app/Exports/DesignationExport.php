...
class DesignationExport implements FromQuery, WithMapping, WithHeadings, ShouldAutoSize, WithEvents {
    use Exportable;

    protected $data;
    public function __construct() {

        $this->data = Designation::all();
    }

    public function query() {

        return Designation::query()->orderBy('sequence');
    }
