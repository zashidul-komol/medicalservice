...
return [
	...
	'menu' => [
	    'configaration' => ['SiteSettingsController', 'LocationsController', 'ZonesController', 'BrandsController', 'SizesController', 'DepotsController', 'DesignationsController' , 'DepartmentsController', 'OfficeLocationsController', 'RegionsController','DamageTypesController', 'StagingsController','DistributorsController', 'ChiefComplainsController'],
